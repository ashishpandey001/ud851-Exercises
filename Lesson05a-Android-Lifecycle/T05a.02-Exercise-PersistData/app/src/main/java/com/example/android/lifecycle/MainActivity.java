...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBBACKS_TEXT_KEY = "callbacks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(LIFECYCLE_CALLBBACKS_TEXT_KEY)) {
            mLifecycleDisplay.setText(savedInstanceState.getString(LIFECYCLE_CALLBBACKS_TEXT_KEY));
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(LIFECYCLE_CALLBBACKS_TEXT_KEY, mLifecycleDisplay.getText().toString());
    }
