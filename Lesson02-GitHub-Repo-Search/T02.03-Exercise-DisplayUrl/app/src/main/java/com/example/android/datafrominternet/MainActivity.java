...
public class MainActivity extends AppCompatActivity {
    ...
    void makeGithubSearchQuery() {
        EditText editTextBox = (EditText) findViewById(R.id.et_search_box);
        TextView urlTextView = (TextView) findViewById(R.id.tv_url_display);
        String editTextData = editTextBox.getText().toString();
        String builtURL = NetworkUtils.buildUrl(editTextData).toString();
        urlTextView.setText(builtURL);
    }
